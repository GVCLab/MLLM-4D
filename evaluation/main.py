...
import os
import sys
from utils.constant import COT_PROMPT, DO_PROMPT, RL_PROMPT
...
def main(
    ...
    if "gpt-4o" in model_name:
        ...
        from model_inference.gemini_video import generate_response
        # from model_inference.openai_compatible import generate_response
    ...
    elif "Phi-4-multimodal" in model_name: 
        from model_inference.phi4mm import generate_response 
    elif "deepseek" in model_name: 
        from model_inference.deepseek import generate_response 
    elif "Qwen3" in model_name: 
        from model_inference.qwen3_vl import generate_response 
    elif "MLLM-4D-SFT" in model_name: 
        from model_inference.qwen3_vl import generate_response 
    elif "MLLM-4D-RFT" in model_name: 
        from model_inference.mllm4d import generate_response 
    else:
